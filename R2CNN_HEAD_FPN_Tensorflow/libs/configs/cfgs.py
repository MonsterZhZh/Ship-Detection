...
# root path
ROO_PATH = os.path.abspath('/home/jzchen/WorkingSpace/R2CNN_HEAD_FPN_Tensorflow')
...
INFERENCE_IMAGE_PATH = '/home/jzchen/data/RemoteSensing/ships/HRSC2016/HRSC2016/Train/AllImages'
INFERENCE_SAVE_PATH = ROO_PATH + '/tools/inference_result'

# Evaluation save path
EVALUATE_R_DIR = ROO_PATH + '/tools/evaluation'
